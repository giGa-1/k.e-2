  ...
  return (
    <section className={cl.section}>
        ...
        </div>
        {
            ...
            :
            <div className={["miniCont", cl.cont].join` `}>
                    ...
                    <ul className={cl.list}>
                        {
                            isMovies.map((e,u)=>{
                                return (
                                    <MoviesCompItem key={u} img={e.url} title={e.name} rating={e.rating} genre={e.genre} year={e.year} descr={e.description} idFilm={e.idFilm}/>
                                )
                            })
                        }
                    </ul>
